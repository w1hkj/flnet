...
Fl_Input2 *sSrchPrefix=(Fl_Input2 *)0;

Fl_Input2 *sSrchArea=(Fl_Input2 *)0;

Fl_Input2 *sSrchSuffix=(Fl_Input2 *)0;
...
Fl_Double_Window* newSearchNetNbrDialog() {
  { winSearchNetNbrDialog = new Fl_Double_Window(207, 107);
    { sSrchNetNbr = new Fl_Input2(80, 30, 50, 25, "Enter Net Number");
      sSrchNetNbr->textfont(13);
      sSrchNetNbr->align(Fl_Align(FL_ALIGN_TOP));
    } // Fl_Input2* sSrchNetNbr
