AC_DEFUN([AC_CHECK_FLTK], [
  ...
  *** contains fltk-config.
      ...
      if test "x$FLTK_API_VERSION" = "x1.1" || test "x$FLTK_API_VERSION" = "x1.3"|| test "x$FLTK_API_VERSION" = "x1.4"; then
  ...
  *** To build $PACKAGE you need a FLTK version that provides API 1.1, 1.3 or 1.4.
          ])
      fi
